...
#Korak1
class Kontakt:
    def __init__(ime, email, telefon):
        self.ime = ime
        self.email = email
...
#Korak3 - metode
    ...
    def odaberi_ucenika(self, event):
        ...
        self.email_entry.insert(0, u.prezime)
        self.telefon_entry.delete(0, tk.END)
        self.telefon_entry.insert(0, u.razred)
    ...
    def spremi_izmjene(self):
        ...
        u.prezime = self.email_entry.get().strip()
        u.razred = self.telefon_entry.get().strip()
